...
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};var ender = require('ender-js')
...
module.exports = $
},{"bonzo/src/ender":7,"domready/src/ender":9,"ender-js":10,"qwery-mobile/ender":11,"reqwest/src/ender":15}],3:[function(require,module,exports){
...
page()
},{"./embed_inject":1,"./inject":4}],4:[function(require,module,exports){
const $           = require('./ender')
...
const $         = require('./ender')
    , badgeHtml =
        ...
        + '<img src="https://nodei.co/npm/{name}.png?downloads=true&stars=true" style="margin-right: 4px;">'
        + '</a>'
        + '<a href="https://nodei.co/npm/{name}/">'
        + '<img src="https://nodei.co/npm-dl/{name}.png?months=6" style="margin-bottom: 6px;">'
        + '</a>'
        + '</div>'
